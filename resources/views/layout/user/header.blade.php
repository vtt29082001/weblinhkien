          ...
          <nav class="navbar hr  ">
           <a class="nav-link btn btn-primary " href="{{route('home')}}" > <i class="fas fa-home"></i>      Trang chủ</a>
            <a class="nav-link" href="{{ route('gioithieu') }}" ><i class="far fa-hand-point-right"></i>   Giới thiệu</a>
               ...
               <div class="dropdown-content">
                <a class="dropdown-item" href="https://www.facebook.com/messages/t/100005740140369/">Chat</a>
                <h6 class="dropdown-item" href="">CSKH: <a href="" class="btn-outline-info">0335564749</a>  <i class="fas fa-angle-right"></i> </h6>
